...
count = 0
while count < qtd_items: #contador
...
#Pegar o item pelo id_product filtrado
id_product_filter = input('Inisira o id do produto que você deseja filtrar: ')
item = cart.get_item_cart_by_product(id_product_filter)
print('Item filtrado', item)

#Remover o item pelo id_product
id_product_remove = input('Insira o id do produto que você deseja remover: ')
item = cart.remove_item_cart_by_product(id_product_remove)
print('Resultado do carrinho com o item removido:', cart.carts)

# calcular o total do carrinho
# calculo = cart.sum_price()